...
class HelloWorld2:
	...
	def __init__(self):
		...
		# Instead of add(), we pack this button into the visible box,
		...
		# Do these the same steps again to create a second button
		...
		# important, but I recommend showing the window last, so it all
		# pops up at once.
		self.button2.show()
		self.box1.show()
		self.window.show()
