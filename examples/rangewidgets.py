...
class RangeWidgets:
	...
	def cb_page_size(self, get, set):
		# Set the page size and page increment size fo the sample
		# adjustment to the value specified by the "Page Size" scale
		set.page_size = get.value
		set.page_incr = get.value
		# Now emit the "changed" signal to reconfigure all widgets
	...
	def __init__(self):
		...
		item = make_menu_item("Discontinuous", self.cb_update_menu_select, gtk.UPDATE_DISCONTINUOUS)
		menu.append(item)
		...
		# scrollbar
		label = gtk.Label("Scrollbr Page Size:")
		box2.pack_start(label, False, False, 0)
		label.show()
