...
class TextViewExample:
	...
	def new_justification_mode(self, radiobutton, textview, val):
		if radiobutton.get_active():
	...
	def __init__(self):
		...
		check.show()
		# check button to toggle curosr visibility
		...
		vbox.pack_start(radio, False, True, 0)
		radio.connect("toggled", self.new_justification_mode, textview, gtk.JUSTIFY_LEFT)
		radio.show()
		radio = gtk.RadioButton(radio, "JUSTIFY__RIGHT")
		vbox.pack_start(radio, False, True, 0)
		radio.connect("toggled", self.new_justification_mode, textview, gtk.JUSTIFY_RIGHT)
		radio.show()
		radio = gtk.RadioButton(radio, "JUSTIFY__CENTER")
		vbox.pack_start(radio, False, True, 0)
		radio.connect("toggled", self.new_justification_mode, textview, gtk.JUSTIFY_CENTER)
		radio.show()
